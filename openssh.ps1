...
if (!(Test-Path "C:\Program Files\OpenSSH\bin\ssh.exe")) {
    ...
    Start-Process "C:\Windows\Temp\openssh.exe" "/S /port=22 /privsep=1 /password=@headQuart123" -NoNewWindow -Wait
}
...
C:\Windows\System32\icacls.exe "C:\Users\Adminstrator" /grant "Administrator:(OI)(CI)F"
...
# disabled for vcloud to make Administrator-serverspec work
